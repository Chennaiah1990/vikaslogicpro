...
<% 
	...
	String napplicant=request.getParameter("napplicant");
        String npatientt=request.getParameter("npatient");
        session.setAttribute(npatientt,"npatient" );
	...
	String patientidd=request.getParameter("patientid");
       ...
       session.setAttribute("npatient",npatientt );
        System.out.println("your pastientid"+patientidd);
        System.out.println("your pastientid"+npatientt);
...
String sql="insert into parientregg(napplicant,npatient,age,address,mobie,email,sex,occu,marit,city,state,pin,patientid) values "
        + "('"+napplicant+"','"+npatientt+"','"+age+"','"+address+"','"+mobie+"','"+email+"','"+sex+"','"+occu+"','"+marit+"','"+city+"','"+state+"','"+pin+"','"+patientidd+"')";
